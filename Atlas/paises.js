(async function () {
    ...
    const i18n = {
        en: { 
            ...
            filter: "Filter Continent:", exit: "🏠 Main Menu"
        },
        es: { 
            pop: "Población", area: "Área", lang: "Idiomas", curr: "Moneda",
            reset: "Reset Mundo", show: "Ocultar nombres", hide: "Mostrar nombres",
            filter: "Filtrar Continente:", exit: "🏠 Menú Principal"
        }
    };

    // DICCIONARIO DE TRADUCCIÓN PARA VALORES DE LA API
    const dict = {
        // Idiomas (Languages)
        ...
        "Hindi": "Hindi", "Bengali": "Bengalí", "Korean": "Coreano", "Turkish": "Turco",
        "Vietnamese": "Vietnamita", "Polish": "Polaco", "Malay": "Malayo",
        // Monedas (Currencies)
        ...
        "Australian dollar": "Dólar australiano", "Chinese yuan": "Yuan chino", "Russian ruble": "Rublo ruso",
        "Indian rupee": "Rupia india", "Brazilian real": "Real brasileño", "Mexican peso": "Peso mexicano"
    };
    ...
    try {
        ...
        // Función para traducir listas (Idiomas) o strings (Monedas)
